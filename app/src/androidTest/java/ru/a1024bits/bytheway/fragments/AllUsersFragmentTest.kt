...
class AllUsersFragmentTest {
    ...
    @Test
    fun testShowUsers() {
        onView(withId(R.id.displayAllUsers)).check(matches(isDisplayed())).perform(RecyclerViewActions.actionOnItemAtPosition<DisplayAllUsersAdapter.UserViewHolder>(1, click()))
        init()
    }

//    @Test
//    fun testOpenFilters() {
//        //todo split this fun on other tests
